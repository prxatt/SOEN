...
const Toast: React.FC<ToastProps> = ({ message, onClose, action }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] p-3 rounded-xl shadow-lg flex items-center gap-3 bg-dark-card text-dark-text border border-dark-border"
      role="alert"
    >
