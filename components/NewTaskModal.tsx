                ...
                <div>
                 ...
                 <motion.div layout className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input type="text" value={taskDetails.isVirtual ? taskDetails.linkedUrl || '' : taskDetails.location || ''} onChange={e => taskDetails.isVirtual ? setTaskDetails({...taskDetails, linkedUrl: e.target.value}) : handleLocationInputChange(e.target.value) } placeholder={taskDetails.isVirtual ? "Virtual meeting link..." : "Location..."} className="block w-full px-3 py-2 pl-10 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-lg" />
